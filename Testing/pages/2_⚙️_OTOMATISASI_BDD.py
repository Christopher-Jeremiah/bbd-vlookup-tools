...
if st.session_state.proses_selesai:
    ...
    if "Pisahkan" in mode_unduh:
        ...
        if list_gabungan:
            ...
            st.download_button(label=f"⬇️ Unduh 1 File Master (Siap untuk VLOOKUP H-1 Besok)", data=df_to_excel(df_gabungan), file_name=f"File Data BBD.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
